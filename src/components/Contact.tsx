...
import { Mail, Phone, MapPin, Send, Clock, Linkedin, Twitter, Instagram } from 'lucide-react';
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Have a project in mind? Get a free consultation and discover how we can help transform your business.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              >
                ...
                <p className="text-gray-400 text-sm mt-2">Mon-Fri, 9 AM - 6 PM IST</p>
              </motion.div>
      ...
      <section className="py-20 bg-[#0B0F17]">
        <div className="max-w-5xl mx-auto px-6">
          ...
          >
            ...
            <button className="px-10 py-5 bg-white text-[#0A84FF] rounded-lg hover:shadow-2xl transition-all text-lg inline-flex items-center gap-2">
              <Phone size={24} />
              Schedule a Call
            </button>
          </motion.div>
